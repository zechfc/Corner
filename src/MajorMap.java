...
public class MajorMap {
    public MajorMap(Major major, ArrayList<Course> concentration, ArrayList<Course> liberalArts,
            ArrayList<Course> carolinaCore, ArrayList<Course> other, HashMap<Course, grade> classesTaken) {
        major = null;
        concentration = null;
        liberalArts = null;
        carolinaCore = null;
